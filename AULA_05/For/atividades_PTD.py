...
# ATIVIDADE 2
# Algoritmo que recebe 10 valores de vendas e calucula o mostra o valor normal da venda, o valor do desconto e o valor
# total a ser pago, considerando, que vendas acima de R$ 1000,00 tem desconto de 10%.
...
for venda in range(3):  # repete o bloco para 10 vendas
    ...
    if valor_venda > 1000:
        ...
        # print(f"O valor a ser pago é: R$ {novo_valor:.2f}") 
