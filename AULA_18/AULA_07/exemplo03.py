...
try:
    ...
    if len(df_roubo_veiculo_outliers_inferiores) > 0:
        ...
        plt.barh(
            df_outliers_inf_grafico['munic'],
            df_outliers_inf_grafico['roubo_veiculo']
        )
    ...
    if len(df_roubo_veiculo_outliers_superiores) > 0:
        ...
        plt.barh(
            df_outliers_sup_grafico['munic'],
            df_outliers_sup_grafico['roubo_veiculo']
        )
