...
try:
    ...
    # # Filtrando por ano de 2022 e 2023
    # df_ocorrencias = df_ocorrencias[
    #     (df_ocorrencias['ano'] == 2022) |
    #     (df_ocorrencias['ano'] == 2023)
    # ]

    # df_ocorrencias = df_ocorrencias[df_ocorrencias['ano'].isin([2022, 2023])]
...
try:
    ...
    print(f'\n10% dos Muncicípios possuem roubos acima de {porcent90:.2f}:')
    print(30*'-')
    df_roubo_veiculo_porcent90 = df_roubo_veiculo[df_roubo_veiculo['roubo_veiculo'] > porcent90]
    print(df_roubo_veiculo_porcent90.sort_values(by='roubo_veiculo', ascending=False))

except Exception as e:
    print(f'Erro ao calcular Percentuais de roubo de veículos: {e}')
    exit()
...
try:
    ...
    plt.barh(
        # .str.slice(0, 10) No máximo 10 caracteres p/ as cidades
        df_roubo_veiculo_maiores['munic'], 
