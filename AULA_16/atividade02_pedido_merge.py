...
try:
    ...
    # =========================================================================
    # MERGE 1
    # Junta clientes com pedidos
    # usando a coluna codigo_cliente
    # =========================================================================
    df_merge1 = pd.merge(
        df_clientes,
        df_pedidos,
    ...
    # usando a coluna codigo_produto
    # =========================================================================
    df_final = pd.merge(
        df_merge2,
        df_produtos,
    ...
    # =========================================================================
    # FILTRO
    # Mostrar apenas clientes da cidade de São Paulo
    # =========================================================================
